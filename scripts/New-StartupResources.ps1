...
Write-Host ""
Write-Host "  IMPORTANT: Configure a Federated Credential on the Service Principal for each"
Write-Host "  GitHub Environment (des, tqs, prd). No client secret is needed."
Write-Host "  See: https://learn.microsoft.com/azure/developer/github/connect-from-azure"
Write-Host ""
Write-Host "  The Service Principal also needs 'Storage Blob Data Contributor' on:"
Write-Host "    Storage Account     : $saName"
Write-Host "    Container           : $containerName"
Write-Host ""
